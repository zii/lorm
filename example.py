...
if __name__ == '__main__':
    ...
    db.add_pool('default', host='127.0.0.1', port=3306, user='root',
                passwd='', db='test', charset='utf8', autocommit=True,
    ...
    # _, id = db.default.execute("insert into pet(file) values(_binary %s)", data)
